---
name: oiticica-precision
description: Apply Oiticica's precision concept in modern English with concise rules, objective rubrics, and concrete contrast.
---

# Oiticica Precision

Use this skill when reviewing or rewriting English prose where precision is the controlling issue.
...
- Positive model: Hardy's rural nouns naming exact tools, plants, and relations.
- Negative model: The fervent ice of her cold indifference burned quietly.
- Required labels should be concrete, such as `choose, replace, check` or a more exact local relation.
