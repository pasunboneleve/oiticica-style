...
- Positive model: The opening pursuit in Stevenson where the black spot, flight, and search advance in order.
- Negative model: A battle report that pauses for costumes, weather, and moral reflections before saying who attacked.
- Required labels should be concrete, such as `keep, name, do` or a more exact local relation.
