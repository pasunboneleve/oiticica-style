...
- Positive model: Wells using scientific terms to name newly imagined machinery and social forms.
- Negative model: We solutionized the problem through ideational futureproofment.
- Required labels should be concrete, such as `accept, reject, check` or a more exact local relation.
