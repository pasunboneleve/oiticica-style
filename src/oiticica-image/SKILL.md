...
- Positive model: Dickens comparing a legal fog to the actual fog around Chancery so image and institution meet.
- Negative model: Hope was a lighthouse, a sword, a garden, and a river in his heart.
- Required labels should be concrete, such as `name, reject, prefer` or a more exact local relation.
