...
- Positive model: A Woolf sentence whose commas mark parenthetic turns without losing the main clause.
- Negative model: The captain, ordered, the sailors, to wait.
- Required labels should be concrete, such as `use, separate, do` or a more exact local relation.
