---
name: oiticica-accumulation
description: Apply Oiticica's accumulation concept in modern English with concise rules, objective rubrics, and concrete contrast.
---

# Oiticica Accumulation

Use this skill when reviewing or rewriting English prose where accumulation is the controlling issue.

Source concept: Accumulation is excess and crossing of aspects, facts, or opinions in one period.
...
- Positive model: Austen's periodic sentence where every insertion bears on the final judgment.
- Negative model: A one-sentence room description that includes windows, history, furniture, weather, ancestry, and moral commentary.
- Required labels should be concrete, such as `split, do, group` or a more exact local relation.
