---
name: oiticica-antithesis
description: Apply Oiticica's antithesis concept in modern English with concise rules, objective rubrics, and concrete contrast.
---

# Oiticica Antithesis

Use this skill when reviewing or rewriting English prose where antithesis is the controlling issue.

Source concept: Antithesis is the opposition of two truths that clarify each other.
...
```markdown
Principle:
<oiticica-antithesis: one sentence naming the concept>
...
Start `Principle` with the exact skill name `oiticica-antithesis`.
