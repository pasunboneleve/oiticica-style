---
name: oiticica-vigor
description: Apply Oiticica's vigor concept in modern English with concise rules, objective rubrics, and concrete contrast.
---

# Oiticica Vigor

Use this skill when reviewing or rewriting English prose where vigor is the controlling issue.
...
```markdown
Principle:
<oiticica-vigor: one sentence naming the concept>
...
Start `Principle` with the exact skill name `oiticica-vigor`.
