...
- Positive model: Stevenson varying short and long sentences during action.
- Negative model: The crowd moved. Shouts. Blades. Blood. Panic. A fall. More shouts.
- Required labels should be concrete, such as `join, keep, restore` or a more exact local relation.
