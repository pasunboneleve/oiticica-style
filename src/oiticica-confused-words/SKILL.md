---
name: oiticica-confused-words
description: Apply Oiticica's confused words concept in modern English with concise rules, objective rubrics, and concrete contrast.
---

# Oiticica Confused Words

Use this skill when reviewing or rewriting English prose where confused words is the controlling issue.

Source concept: Crossing is the exchange of similar words.
...
- Positive model: A Conan Doyle sentence that uses inference and observation in their distinct senses.
- Negative model: The witness inferred that the detective implied the clue from the ash.
- Required labels should be concrete, such as `check, correct, flag` or a more exact local relation.
