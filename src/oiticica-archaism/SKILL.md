---
name: oiticica-archaism
description: Apply Oiticica's archaism concept in modern English with concise rules, objective rubrics, and concrete contrast.
---

# Oiticica Archaism

Use this skill when reviewing or rewriting English prose where archaism is the controlling issue.

Source concept: Archaism is use of an old word or construction now out of use.
...
```markdown
Principle:
<oiticica-archaism: one sentence naming the concept>
...
Start `Principle` with the exact skill name `oiticica-archaism`.
