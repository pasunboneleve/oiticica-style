...
- For ambiguous attachment, select `oiticica-ambiguity`, name both possible readings, and if the user gives no intended reading, choose one plausible reading in the revision and make the choice explicit. In the revision, repeat the intended actor or object by name when a pronoun would preserve the ambiguity.
